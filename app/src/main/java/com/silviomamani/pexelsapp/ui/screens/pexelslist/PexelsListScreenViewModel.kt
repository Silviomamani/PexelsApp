...
import com.silviomamani.pexelsapp.PexelsResult

class PexelsListScreenViewModel : ViewModel()
{
...
init{
    ...
    fun fetchFotos (){
        uiState = uiState.copy(pexelsList = getPexelsList())
    }
}


fun getPexelsList() : List <Fotos>{
    val gson = Gson()
